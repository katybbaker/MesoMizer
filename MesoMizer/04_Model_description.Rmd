...
2) [carrion],
3) [detritus],
4) [Carbon Injection Potential (CIP)] and 
5) [DIC pools]
...
# 4 Carbon Injection potential (CIP)


Carbon injection potential (CIP) is the taxon specific physiological rates that control how much carbon an individual can release in a given time period. This is estimated from the sum of metabolic waste (respired carbon, RC), detritus production (fecal carbon, FC) and carrion production (carcass carbon, CC). Note, excretory carbon not included. 
