...
dim(diet_4d) #13 predators with 100 sizes and 14 prey with 260 sizes - need to add resource to "predator". In this case resource predator will have all prey size classes = 0
...
updated_diet_4d <- array(0, dim = c(14, 100, 14, 260))
...
zoopTL <- 1  # Background resource trophic level
