...
sp_1 <-
  data.frame(
    ...
    "w_inf" = c(0.417,0.318,1.7,0.1,26.78,58.3,3.0,81.43,20,1.0,0.28,375.8,12), #references in species_params -> Mesomizer species params spreadsheet
    "beta" = c(100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 200, 200), #lower ppmr for piscivores, higher for omnivores and planktivores
...
```{r}
 ...
 sp_2 <- newMultispeciesParams(sp_1, sp_2_inter, w_pp_cutoff = 0.01) #changed to 0.001 in later iteration 
